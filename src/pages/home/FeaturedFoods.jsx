...
const FeaturedFoods = () => {
    ...
    const {data:featureFoods, isError, isLoading, refetch} = useQuery({
              ...
              <div className="card card-compact bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                  <div className=" flex justify-between items-center">
                    ...
                    <div>
                      <h3>
                        <span className="text-[#d59a11]">Expired Date : </span>
                        {food?.expired_date}
                      </h3>
                    </div>
                  </div>
                  ...
                  <h3 className="text-lg">
                    <span className="text-[#d59a11]">Additional Notes : </span>
