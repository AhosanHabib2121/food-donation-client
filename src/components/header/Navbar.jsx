          ...
          <div className="navbar px-0 text-white py-2  max-w-7xl md:mx-auto">
            <div className="navbar-start">
              <div className="dropdown">
                ...
                <ul
                  tabIndex={0}
                  className="menu-sm dropdown-content mt-3 z-[1] p-2 shadow text-white bg-[#ffb606] rounded-box w-52">
                  {navLink}
                </ul>
              </div>
            ...
            <div className="navbar-end ">
              ...
              <div className="dropdown dropdown-end">
                <label tabIndex={0} className="btn btn-ghost px-0 md:hidden">
                  ...
                  <Link
                    to="/login"
                    className=" bg-[#d59a11] text-[#fff] px-5 py-2 rounded-lg font-medium hover:bg-[#d59a11]">
                    Login
                  </Link>
                </label>
                {/* {user ? (
